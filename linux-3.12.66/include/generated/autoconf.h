 ...
 * Linux/x86 3.12.49 Kernel Configuration
 *
 */
...
#define CONFIG_HAVE_SET_MEMORY_RO 1
...
#define CONFIG_PRAMFS_SECURITY 1
...
#define CONFIG_PRAMFS_POSIX_ACL 1
